...
public class FindDuplicates {
    ...
    public static List<Integer> findDuplicatesNestedLoops(List<Integer> l) {
        List<Integer> duplicates = new ArrayList<>(); // Makes a list of duplicates and stores them in an array
            ...
            for (int j = i + 1; j < l.size(); j++) {
                ...
                if (first.equals(second)) {
                    if (!duplicates.contains(first)) {
                        ...
                        // Print the duplicate right when it's added
                        System.out.println("Found duplicate: " + first);
                    }
                }
